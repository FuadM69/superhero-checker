...
Проект содержит интеграционные тесты, которые проверяют:
...
Все тесты используют реальный API без моков. При недоступности сети или блокировке прокси тесты пропускаются с соответствующим сообщением.
